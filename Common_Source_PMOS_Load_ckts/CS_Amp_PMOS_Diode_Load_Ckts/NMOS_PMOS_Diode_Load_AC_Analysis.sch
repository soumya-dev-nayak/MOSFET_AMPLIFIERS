...
C {devices/code.sym} 20 -100 0 0 {name=TT_MODELS
only_toplevel=true
...
C {vsource.sym} 220 190 0 0 {name=VG value="DC 0.850 AC 1 sin(0.850 1m 1k)" savecurrent=false}
C {vsource.sym} 80 170 0 0 {name=VDD value=1.8 savecurrent=false}
C {gnd.sym} 80 240 0 0 {name=l3 lab=GND}
C {lab_wire.sym} 80 100 0 0 {name=p2 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 350 -140 0 0 {name=p3 sig_type=std_logic lab=VDD}
C {ipin.sym} 220 140 0 0 {name=p4 lab=Vin}
C {simulator_commands_shown.sym} 590 -130 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
* ngspice commands
...
plot gain_db title 'Gain in DB'
plot phase

*Measuring the UGB
meas ac UGB when gain_db = 0

*Finding the pole frequnecy
let A0 = gain_db[0]
let A3dB = A0 - 3
